...
#define __PIN_TO_EXTI_IRQn(PIN) (PIN == 0) ? EXTI0_IRQn : (PIN == 1) ? EXTI1_IRQn : (PIN == 2) ? EXTI2_IRQn : (PIN == 3) ? EXTI3_IRQn : (PIN == 4) ? EXTI4_IRQn : (PIN <= 9) ? EXTI9_5_IRQn : EXTI15_10_IRQn
